...
/**
 * shadcn/ui Dialog (new-york) — Radix Dialog tabanli modal pencere. Admin
 * CRUD formlari (kategori/sosyal medya ekle-duzenle) icin kullanilir.
 * Escape/disari tiklama ile kapanir; yikici onaylar icin AlertDialog tercih edilir.
 */
